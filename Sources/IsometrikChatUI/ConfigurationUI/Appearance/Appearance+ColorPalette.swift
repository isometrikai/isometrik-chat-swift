...
public struct ISMChatColorPalette {
    ...
    public var messageListMessageText : Color = .ismChatSdkAccentPrimary
    ...
    public var messageListMessageTime : Color = .ismChatSdkGray
