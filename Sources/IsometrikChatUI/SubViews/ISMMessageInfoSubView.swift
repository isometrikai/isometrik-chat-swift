    ...
    var body: some View {
        HStack{
            if message.deletedMessage == true{
                ...
                case .text:
                    if let customView = CustomMessageBubbleViewRegistry.shared.view(for: message, details:  nil) {
                ...
                default:
                    CustomMessageBubbleViewRegistry.shared.view(for: self.message, details: nil)
                }
            }
        }
