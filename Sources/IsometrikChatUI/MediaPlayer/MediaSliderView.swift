...
//                        ScrollView(.horizontal, showsIndicators: false) { // Make sure it's a horizontal scroll view
//                            LazyHStack(spacing: 1) { // Adjust spacing as needed
...
//                                        .resizable()
//                                        .scaledToFill()
//                                        .frame(width: 30, height: 35) // Adjust the thumbnail size as needed
//                                        .clipped()
