...
//                        Spacer()
//                        Button { 
//                            ISMChatHelper.downloadImage(from: data[selectedIndex].mediaUrl)
//                        } label: {
...
//                    }
//                }
//                .navigationDestination(isPresented: $navigatetoMedia, destination: {
//                    ISMUserMediaView(viewModel:viewModel)
//                        .environmentObject(self.reamlManager)
//                })
