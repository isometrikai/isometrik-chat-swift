...
extension Font {
    static public func light(size: CGFloat) -> Font {
        return Font.custom("ProductSans-Light", size: size)
    }

    static public func regular(size: CGFloat) -> Font {
        return Font.custom("ProductSans-Regular", size: size)
    }

    static public func medium(size: CGFloat) -> Font {
        return Font.custom("ProductSans-Medium", size: size)
    }
    
    static public func bold(size: CGFloat) -> Font {
        return Font.custom("ProductSans-Bold", size: size)
    }
    
    static public func italic(size: CGFloat) -> Font {
