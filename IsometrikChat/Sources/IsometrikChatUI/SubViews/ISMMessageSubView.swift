...
//    @State var metaData : LPLinkMetadata? = nil
    ...
    @State var showReplyOption = ISMChatSdk.getInstance().getChatClient().getChatPageProperties().features.contains(.reply)
    @State var showForwardOption = ISMChatSdk.getInstance().getChatClient().getChatPageProperties().features.contains(.forward)
    @State var showEditOption = ISMChatSdk.getInstance().getChatClient().getChatPageProperties().features.contains(.edit)
