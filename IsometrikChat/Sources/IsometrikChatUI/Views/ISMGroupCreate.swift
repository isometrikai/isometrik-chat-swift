...
struct ISMGroupCreate: View {
    ...
    @Binding var userSelected : [ISMChat_User]
            ...
            if !groupName.isEmpty{
                Button {
                    ...
                    themeImage.removeSearchText
                        .tint(themeColor.messageList_ReplyToolbarRectangle)
                }.frame(width: 30)
            }
    ...
    var navBarTrailingBtn: some View {
        VStack{
            Button(action: {
                ...
                Text("Create")
                    .font(themeFonts.messageList_MessageText)
                    .foregroundColor(userSelected.count > 0 ? themeColor.userProfile_editText : .gray)
            }
        }
    }
